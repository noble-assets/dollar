...
// IsVaultsProgramEnded is a utility that returns if the vaults program has ended.
func (k *Keeper) IsVaultsProgramEnded(ctx context.Context) bool {
	ended, _ := k.VaultsProgramEnded.Get(ctx)
	return ended
}
