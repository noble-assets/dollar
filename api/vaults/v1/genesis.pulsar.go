...
var (
	...
	fd_GenesisState_program_ended            protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_GenesisState_program_ended = md_GenesisState.Fields().ByName("program_ended")
}
...
func (x *fastReflection_GenesisState) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.ProgramEnded != false {
		value := protoreflect.ValueOfBool(x.ProgramEnded)
		if !f(fd_GenesisState_program_ended, value) {
			return
		}
	}
}
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "noble.dollar.vaults.v1.GenesisState.stats":
		return x.Stats != nil
	case "noble.dollar.vaults.v1.GenesisState.program_ended":
		return x.ProgramEnded != false
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_GenesisState) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "noble.dollar.vaults.v1.GenesisState.program_ended":
		panic(fmt.Errorf("field program_ended of message noble.dollar.vaults.v1.GenesisState is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: noble.dollar.vaults.v1.GenesisState"))
		}
...
func (x *fastReflection_GenesisState) ProtoMethods() *protoiface.Methods {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 7:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field ProgramEnded", wireType)
				}
				var v int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
...
func (x *GenesisState) GetProgramEnded() bool {
	if x != nil {
		return x.ProgramEnded
	}
	return false
}
...
var file_noble_dollar_vaults_v1_genesis_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa1, 0x03, 0x0a, 0x0c, 0x47, 0x65, 0x6e, 0x65,
	...
	0x79, 0x70, 0x65, 0x52, 0x06, 0x70, 0x61, 0x75, 0x73, 0x65, 0x64, 0x12, 0x39, 0x0a, 0x05, 0x73,
	...
	0x05, 0x73, 0x74, 0x61, 0x74, 0x73, 0x12, 0x23, 0x0a, 0x0d, 0x70, 0x72, 0x6f, 0x67, 0x72, 0x61,
	0x6d, 0x5f, 0x65, 0x6e, 0x64, 0x65, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0c, 0x70,
	0x72, 0x6f, 0x67, 0x72, 0x61, 0x6d, 0x45, 0x6e, 0x64, 0x65, 0x64, 0x42, 0xde, 0x01, 0x0a, 0x1a,
	...
	0x73, 0x69, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x37, 0x64, 0x6f, 0x6c, 0x6c,
...
var file_noble_dollar_vaults_v1_genesis_proto_goTypes = []interface{}{
	...
	(*Stats)(nil),         // 4: noble.dollar.vaults.v1.Stats
}
var file_noble_dollar_vaults_v1_genesis_proto_depIdxs = []int32{
	...
	4, // 3: noble.dollar.vaults.v1.GenesisState.stats:type_name -> noble.dollar.vaults.v1.Stats
