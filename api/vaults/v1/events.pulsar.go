...
func init() {
	...
	md_PeerUpdated = File_noble_dollar_vaults_v1_events_proto.Messages().ByName("PeerUpdated")
...
func (x *fastReflection_PeerUpdated) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "noble.dollar.vaults.v1.PeerUpdated.chain":
		return x.Chain != uint32(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: noble.dollar.vaults.v1.PeerUpdated"))
		}
		panic(fmt.Errorf("message noble.dollar.vaults.v1.PeerUpdated does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PeerUpdated) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message noble.dollar.vaults.v1.PeerUpdated does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PeerUpdated) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "noble.dollar.vaults.v1.PeerUpdated.chain":
		panic(fmt.Errorf("field chain of message noble.dollar.vaults.v1.PeerUpdated is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: noble.dollar.vaults.v1.PeerUpdated"))
		}
...
func (x *fastReflection_PeerUpdated) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in noble.dollar.vaults.v1.PeerUpdated", d.FullName()))
	}
	panic("unreachable")
}
...
var file_noble_dollar_vaults_v1_events_proto_rawDesc = []byte{
	...
	0x6c, 0x61, 0x72, 0x2e, 0x76, 0x61, 0x75, 0x6c, 0x74, 0x73, 0x2e, 0x76, 0x31, 0x1a, 0x14, 0x67,
	0x6f, 0x67, 0x6f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x6f, 0x67, 0x6f, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x22, 0x33, 0x0a, 0x0b, 0x50, 0x65, 0x65, 0x72, 0x55, 0x70, 0x64, 0x61, 0x74,
	...
	0x36, 0x52, 0x05, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x42, 0xda, 0x01, 0x0a, 0x1a, 0x63, 0x6f, 0x6d,
	0x2e, 0x6e, 0x6f, 0x62, 0x6c, 0x65, 0x2e, 0x64, 0x6f, 0x6c, 0x6c, 0x61, 0x72, 0x2e, 0x76, 0x61,
	0x75, 0x6c, 0x74, 0x73, 0x2e, 0x76, 0x31, 0x42, 0x0b, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x50,
...
var file_noble_dollar_vaults_v1_events_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_noble_dollar_vaults_v1_events_proto_goTypes = []interface{}{
	(*PeerUpdated)(nil), // 0: noble.dollar.vaults.v1.PeerUpdated
}
