...
var (
	md_SupportedBridgingPathSet                      protoreflect.MessageDescriptor
	fd_SupportedBridgingPathSet_destination_chain_id protoreflect.FieldDescriptor
	fd_SupportedBridgingPathSet_destination_token    protoreflect.FieldDescriptor
	fd_SupportedBridgingPathSet_supported            protoreflect.FieldDescriptor
)

func init() {
	file_noble_dollar_portal_v1_events_proto_init()
	md_SupportedBridgingPathSet = File_noble_dollar_portal_v1_events_proto.Messages().ByName("SupportedBridgingPathSet")
	fd_SupportedBridgingPathSet_destination_chain_id = md_SupportedBridgingPathSet.Fields().ByName("destination_chain_id")
	fd_SupportedBridgingPathSet_destination_token = md_SupportedBridgingPathSet.Fields().ByName("destination_token")
	fd_SupportedBridgingPathSet_supported = md_SupportedBridgingPathSet.Fields().ByName("supported")
}

var _ protoreflect.Message = (*fastReflection_SupportedBridgingPathSet)(nil)

type fastReflection_SupportedBridgingPathSet SupportedBridgingPathSet

func (x *SupportedBridgingPathSet) ProtoReflect() protoreflect.Message {
	return (*fastReflection_SupportedBridgingPathSet)(x)
}

func (x *SupportedBridgingPathSet) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_SupportedBridgingPathSet_messageType fastReflection_SupportedBridgingPathSet_messageType
var _ protoreflect.MessageType = fastReflection_SupportedBridgingPathSet_messageType{}

type fastReflection_SupportedBridgingPathSet_messageType struct{}

func (x fastReflection_SupportedBridgingPathSet_messageType) Zero() protoreflect.Message {
	return (*fastReflection_SupportedBridgingPathSet)(nil)
}
func (x fastReflection_SupportedBridgingPathSet_messageType) New() protoreflect.Message {
	return new(fastReflection_SupportedBridgingPathSet)
}
func (x fastReflection_SupportedBridgingPathSet_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_SupportedBridgingPathSet
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_SupportedBridgingPathSet) Descriptor() protoreflect.MessageDescriptor {
	return md_SupportedBridgingPathSet
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_SupportedBridgingPathSet) Type() protoreflect.MessageType {
	return _fastReflection_SupportedBridgingPathSet_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_SupportedBridgingPathSet) New() protoreflect.Message {
	return new(fastReflection_SupportedBridgingPathSet)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_SupportedBridgingPathSet) Interface() protoreflect.ProtoMessage {
	return (*SupportedBridgingPathSet)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_SupportedBridgingPathSet) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.DestinationChainId != uint32(0) {
		value := protoreflect.ValueOfUint32(x.DestinationChainId)
		if !f(fd_SupportedBridgingPathSet_destination_chain_id, value) {
			return
		}
	}
	if len(x.DestinationToken) != 0 {
		value := protoreflect.ValueOfBytes(x.DestinationToken)
		if !f(fd_SupportedBridgingPathSet_destination_token, value) {
			return
		}
	}
	if x.Supported != false {
		value := protoreflect.ValueOfBool(x.Supported)
		if !f(fd_SupportedBridgingPathSet_supported, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_SupportedBridgingPathSet) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "noble.dollar.portal.v1.SupportedBridgingPathSet.destination_chain_id":
		return x.DestinationChainId != uint32(0)
	case "noble.dollar.portal.v1.SupportedBridgingPathSet.destination_token":
		return len(x.DestinationToken) != 0
	case "noble.dollar.portal.v1.SupportedBridgingPathSet.supported":
		return x.Supported != false
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: noble.dollar.portal.v1.SupportedBridgingPathSet"))
		}
		panic(fmt.Errorf("message noble.dollar.portal.v1.SupportedBridgingPathSet does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_SupportedBridgingPathSet) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "noble.dollar.portal.v1.SupportedBridgingPathSet.destination_chain_id":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_SupportedBridgingPathSet) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "noble.dollar.portal.v1.SupportedBridgingPathSet.destination_chain_id":
	...
	default:
		...
		panic(fmt.Errorf("message noble.dollar.portal.v1.SupportedBridgingPathSet does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_SupportedBridgingPathSet) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "noble.dollar.portal.v1.SupportedBridgingPathSet.destination_chain_id":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_SupportedBridgingPathSet) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "noble.dollar.portal.v1.SupportedBridgingPathSet.destination_chain_id":
		panic(fmt.Errorf("field destination_chain_id of message noble.dollar.portal.v1.SupportedBridgingPathSet is not mutable"))
	case "noble.dollar.portal.v1.SupportedBridgingPathSet.destination_token":
		panic(fmt.Errorf("field destination_token of message noble.dollar.portal.v1.SupportedBridgingPathSet is not mutable"))
	case "noble.dollar.portal.v1.SupportedBridgingPathSet.supported":
		panic(fmt.Errorf("field supported of message noble.dollar.portal.v1.SupportedBridgingPathSet is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: noble.dollar.portal.v1.SupportedBridgingPathSet"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_SupportedBridgingPathSet) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "noble.dollar.portal.v1.SupportedBridgingPathSet.destination_chain_id":
		return protoreflect.ValueOfUint32(uint32(0))
	case "noble.dollar.portal.v1.SupportedBridgingPathSet.destination_token":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_SupportedBridgingPathSet) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in noble.dollar.portal.v1.SupportedBridgingPathSet", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_SupportedBridgingPathSet) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_SupportedBridgingPathSet) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_SupportedBridgingPathSet) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_SupportedBridgingPathSet) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*SupportedBridgingPathSet)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: SupportedBridgingPathSet: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: SupportedBridgingPathSet: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 0 {
...
func (x *SupportedBridgingPathSet) Reset() {
	*x = SupportedBridgingPathSet{}
	if protoimpl.UnsafeEnabled {
		mi := &file_noble_dollar_portal_v1_events_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *SupportedBridgingPathSet) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SupportedBridgingPathSet) ProtoMessage() {}

// Deprecated: Use SupportedBridgingPathSet.ProtoReflect.Descriptor instead.
func (*SupportedBridgingPathSet) Descriptor() ([]byte, []int) {
	return file_noble_dollar_portal_v1_events_proto_rawDescGZIP(), []int{1}
}

func (x *SupportedBridgingPathSet) GetDestinationChainId() uint32 {
	if x != nil {
...
func (x *SupportedBridgingPathSet) GetDestinationToken() []byte {
	if x != nil {
...
func (x *SupportedBridgingPathSet) GetSupported() bool {
	if x != nil {
		return x.Supported
	}
	return false
...
var file_noble_dollar_portal_v1_events_proto_rawDesc = []byte{
	...
	,
	...
	0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x1c, 0x0a, 0x09, 0x73, 0x75, 0x70, 0x70, 0x6f, 0x72, 0x74,
	0x65, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09, 0x73, 0x75, 0x70, 0x70, 0x6f, 0x72,
	0x74, 0x65, 0x64, 0x22, 0x5a, 0x0a, 0x14, 0x4f, 0x77, 0x6e, 0x65, 0x72, 0x73, 0x68, 0x69, 0x70,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x6e, 0x65, 0x77, 0x4f, 0x77, 0x6e, 0x65, 0x72, 0x42,
	0xda, 0x01, 0x0a, 0x1a, 0x63, 0x6f, 0x6d, 0x2e, 0x6e, 0x6f, 0x62, 0x6c, 0x65, 0x2e, 0x64, 0x6f,
	0x6c, 0x6c, 0x61, 0x72, 0x2e, 0x70, 0x6f, 0x72, 0x74, 0x61, 0x6c, 0x2e, 0x76, 0x31, 0x42, 0x0b,
	0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x34, 0x64,
...
var file_noble_dollar_portal_v1_events_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_noble_dollar_portal_v1_events_proto_goTypes = []interface{}{
	(*PeerUpdated)(nil),              // 0: noble.dollar.portal.v1.PeerUpdated
	(*SupportedBridgingPathSet)(nil), // 1: noble.dollar.portal.v1.SupportedBridgingPathSet
...
func file_noble_dollar_portal_v1_events_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_noble_dollar_portal_v1_events_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SupportedBridgingPathSet); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
