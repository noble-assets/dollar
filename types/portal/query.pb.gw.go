...
var (
	...
	pattern_Query_Paused_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"noble", "dollar", "portal", "v1", "paused"}, "", runtime.AssumeColonVerbOpt(false)))
