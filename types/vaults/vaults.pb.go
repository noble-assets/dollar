...
type Stats struct {
	Vaults map[int32]Stats_Vault `protobuf:"bytes,1,rep,name=vaults,proto3" json:"vaults" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *Stats) GetVaults() map[int32]Stats_Vault {
	if m != nil {
		return m.Vaults
	}
	return nil
...
type Stats_Vault struct {
	...
	TotalUsers     cosmossdk_io_math.Int `protobuf:"bytes,2,opt,name=total_users,json=totalUsers,proto3,customtype=cosmossdk.io/math.Int" json:"total_users"`
...
func (m *Stats_Vault) Reset()         { *m = Stats_Vault{} }
func (m *Stats_Vault) String() string { return proto.CompactTextString(m) }
func (*Stats_Vault) ProtoMessage()    {}
func (*Stats_Vault) Descriptor() ([]byte, []int) {
	return fileDescriptor_1a185cec7ba75cfc, []int{3, 1}
}
func (m *Stats_Vault) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *Stats_Vault) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_Stats_Vault.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *Stats_Vault) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Stats_Vault.Merge(m, src)
}
func (m *Stats_Vault) XXX_Size() int {
	return m.Size()
}
func (m *Stats_Vault) XXX_DiscardUnknown() {
	xxx_messageInfo_Stats_Vault.DiscardUnknown(m)
}

var xxx_messageInfo_Stats_Vault proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterMapType((map[int32]Stats_Vault)(nil), "noble.dollar.vaults.v1.Stats.VaultsEntry")
	proto.RegisterType((*Stats_Vault)(nil), "noble.dollar.vaults.v1.Stats.Vault")
}
...
var fileDescriptor_1a185cec7ba75cfc = []byte{
	...
	,
}
...
func (m *Stats) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Vaults) > 0 {
		for k := range m.Vaults {
			...
			i--
			dAtA[i] = 0x12
			i = encodeVarintVaults(dAtA, i, uint64(k))
			i--
			dAtA[i] = 0x8
			i = encodeVarintVaults(dAtA, i, uint64(baseI-i))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *Stats_Vault) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Stats_Vault) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Stats_Vault) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	dAtA[i] = 0x1a
	{
		size := m.TotalUsers.Size()
		i -= size
		if _, err := m.TotalUsers.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintVaults(dAtA, i, uint64(size))
	}
...
func (m *Stats) Size() (n int) {
	...
	if len(m.Vaults) > 0 {
		for k, v := range m.Vaults {
			...
			_ = v
			l = v.Size()
			mapEntrySize := 1 + sovVaults(uint64(k)) + 1 + l + sovVaults(uint64(l))
			n += mapEntrySize + 1 + sovVaults(uint64(mapEntrySize))
		}
	}
	return n
}

func (m *Stats_Vault) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Stats) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Vaults == nil {
				m.Vaults = make(map[int32]Stats_Vault)
			}
			var mapkey int32
...
func (m *Stats_Vault) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 2:
			...
			if err := m.TotalUsers.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
