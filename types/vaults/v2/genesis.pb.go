...
type VaultConfig struct {
	...
	MaxTotalDeposits cosmossdk_io_math.Int `protobuf:"bytes,6,opt,name=max_total_deposits,json=maxTotalDeposits,proto3,customtype=cosmossdk.io/math.Int" json:"max_total_deposits"`
	// Target yield rate (informational)
	TargetYieldRate cosmossdk_io_math.LegacyDec `protobuf:"bytes,7,opt,name=target_yield_rate,json=targetYieldRate,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"target_yield_rate"`
}
...
func (m *VaultConfig) GetVaultType() vaults.VaultType {
	if m != nil {
		return m.VaultType
	}
...
type UserPositionEntry struct {
	...
	Position UserPosition `protobuf:"bytes,3,opt,name=position,proto3" json:"position"`
}
...
func (m *UserPositionEntry) GetVaultType() vaults.VaultType {
	if m != nil {
		return m.VaultType
	}
	return vaults.UNSPECIFIED
...
type NAVEntry struct {
	...
	VaultType vaults.VaultType `protobuf:"varint,1,opt,name=vault_type,json=vaultType,proto3,enum=noble.dollar.vaults.v1.VaultType" json:"vault_type,omitempty"`
	// NAV information
	NavInfo NAVInfo `protobuf:"bytes,2,opt,name=nav_info,json=navInfo,proto3" json:"nav_info"`
}
...
func (m *NAVEntry) GetVaultType() vaults.VaultType {
	if m != nil {
		return m.VaultType
	}
	return vaults.UNSPECIFIED
...
type FeeConfigEntry struct {
	...
	VaultType vaults.VaultType `protobuf:"varint,1,opt,name=vault_type,json=vaultType,proto3,enum=noble.dollar.vaults.v1.VaultType" json:"vault_type,omitempty"`
	// Fee configuration
	FeeConfig FeeConfig `protobuf:"bytes,2,opt,name=fee_config,json=feeConfig,proto3" json:"fee_config"`
}
...
func (m *FeeConfigEntry) GetVaultType() vaults.VaultType {
	if m != nil {
		return m.VaultType
	}
	return vaults.UNSPECIFIED
...
type ExitRequestEntry struct {
	...
	ExitRequest ExitRequest `protobuf:"bytes,3,opt,name=exit_request,json=exitRequest,proto3" json:"exit_request"`
}
...
func (m *ExitRequestEntry) GetVaultType() vaults.VaultType {
	if m != nil {
		return m.VaultType
	}
	return vaults.UNSPECIFIED
...
func (m *SharesTotalEntry) GetVaultType() vaults.VaultType {
	if m != nil {
		return m.VaultType
	}
	return vaults.UNSPECIFIED
...
type VaultStatsEntry struct {
	...
	TotalDeposited cosmossdk_io_math.Int `protobuf:"bytes,3,opt,name=total_deposited,json=totalDeposited,proto3,customtype=cosmossdk.io/math.Int" json:"total_deposited"`
	// Total value withdrawn (cumulative)
	TotalWithdrawn cosmossdk_io_math.Int `protobuf:"bytes,4,opt,name=total_withdrawn,json=totalWithdrawn,proto3,customtype=cosmossdk.io/math.Int" json:"total_withdrawn"`
	// Total fees collected
	TotalFeesCollected cosmossdk_io_math.Int `protobuf:"bytes,5,opt,name=total_fees_collected,json=totalFeesCollected,proto3,customtype=cosmossdk.io/math.Int" json:"total_fees_collected"`
	// Total yield distributed
	TotalYieldDistributed cosmossdk_io_math.Int `protobuf:"bytes,6,opt,name=total_yield_distributed,json=totalYieldDistributed,proto3,customtype=cosmossdk.io/math.Int" json:"total_yield_distributed"`
	...
	AveragePositionSize cosmossdk_io_math.LegacyDec `protobuf:"bytes,8,opt,name=average_position_size,json=averagePositionSize,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"average_position_size"`
}
...
func (m *VaultStatsEntry) GetVaultType() vaults.VaultType {
	if m != nil {
		return m.VaultType
	}
	return vaults.UNSPECIFIED
...
var fileDescriptor_a687c7a1c262a427 = []byte{
	...
	,
}
...
func (m *VaultConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.VaultType != 0 {
		i = encodeVarintGenesis(dAtA, i, uint64(m.VaultType))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *VaultConfig) Size() (n int) {
	...
	_ = l
	if m.VaultType != 0 {
		n += 1 + sovGenesis(uint64(m.VaultType))
	}
	if m.Enabled {
		n += 2
	}
